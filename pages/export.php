		...
		<section id="container" >
					...
					<ul class="sidebar-menu" id="nav-accordion">
						...
						<li class="sub-menu">
							...
							<ul class="sub">
								...
								<li class="active">  <a href="export.php" title="Export">Export</a> </li>
							</ul>
						</li>
					</ul>
				</div>
			...
			<section id="main-content">
				<section class="wrapper">
					<h3><i class="fa fa-upload"></i> Exporter une collection : </h3>
					<hr/>
					<div class="col-lg-12">
						<div class="form-panel">
							<form method="post" >
								<table id="todo" class="table table">
									<tbody>
										<tr><th>Nom de la collection</th><td></td></tr>
										<tr><td> <span  class="check">
										collectionProjet </td><td><input type="radio" name="videc" value="collectionProjet" checked>
									</span></td></tr>
									<tr><td> <span  class="check">
										authentification </td><td><input type="radio" name="videc" value="authentification">
									</span></td></tr>
									
								</tbody>
							</table>
							<center>
							<input  type="submit" name="envoi" onclick="return confirm('Voulez-vous vraiment exporter cette collection ?')" value="Exporter" class="btn btn-success btn-round btn-info"/></center>
						</form>
					</div>
				</div>
				<?php
				...
				if($_POST['videc']=="collectionProjet"){
							$path=$path."/publications.json";
				system("mongoexport --db dbProjet --collection collectionProjet --out ".$path );
				echo '<script language="JavaScript">
				</script><br><br><br><br><br><br><br><br><br><br><br><br><br><center><p style="width:680px; height:50px;" class="alert alert-success"> <b>OK!</b> Vous trouvez votre collection dans ce chemin: <b> '. $path.'</b></p></center>'  ;
				}
				else if($_POST['videc']=="authentification"){
				$path=$path."/authentification.json";
				system("mongoexport --db dbProjet --collection authentification --out ".$path );
				echo '<script language="JavaScript">
				</script><br><br><br><br><br><br><br><br><br><br><br><br><br><center><p style="width:680px; height:50px;" class="alert alert-success"> <b>OK!</b> Vous trouvez votre collection dans ce chemin: <b> '. $path.'</b></p></center>'  ;
				}
				}
