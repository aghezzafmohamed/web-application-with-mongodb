        ...
        <section class="wrapper">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Ouvrages de recherche avec ISBN :</h4>
              ...
              echo " <table id='todo' class='table table-hover custom-check'>";
                ...
                echo "<form action='affiche333.php' method='post'>";
                  ...
                  else if($val=="Lieu d’édition"){
                  $val="Lieu_Edition";
                  }
                  else if($val=="Année de publication"){
                  $val="Annee";
                  }
                  else if($val=="ISBN/ISSN"){
                  $val="ISBN/ISSN";
                  }
                  else if($val=="Dépôt légal"){
                  $val="Depot_legal";
                  }
                ...
                <table><tr><td>
                  <b>Sort &nbsp</b> <select  name='choix' onclick='enable()' class='btn btn-default dropdown-toggle'>
                    ...
                    <option>Lieu_Edition</option>
                    <option>Annee</option>
                    <option>ISBN/ISSN</option>
                    <option>Depot_legal</option>
                  </select>&nbsp &nbsp
              ...
              ";
            echo "</table> ";
            echo " <input type='hidden' name='type' value='Ouvrages de recherche avec ISBN'> ";
            echo " <center>
