...
<html >
  ...
  <body>
    <section id="container" >
          ...
          <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
              ...
              <ul class="sub">
                ...
                <li  class="active"><a title="Publications dans des actes de congrès scientifiques" href="affiche5.php">Publications dans des actes de congrès scientifiques</a></li>
        ...
        <section class="wrapper">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Publication dans des actes de congrès scientifiques  :</h4>
              <?php
              $var=$_GET['id'];
              $auteur="";
              require "outils/vendor/autoload.php";
              ...
              echo"     <form class='form-horizontal style-form' method='post'  >
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Titre complet de la communication</label>
                  <div class='col-sm-10'>
                    <input type='text' name='titre6' value=".stripslashes (json_encode($docs['Titre_complet'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                ...
                echo"         <div class='form-group'>
                  ...
                  <div class='col-sm-10'>
                    <input type='text' name='auteur6' value=".stripslashes (json_encode($auteur,JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                
                echo"         <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Nom complet du périodique scientifique</label>
                  <div class='col-sm-10'>
                    <input type='text' name='nom6' value=".stripslashes (json_encode($docs['Nom_complet'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                
                echo"         <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Lieu d’organisation</label>
                  <div class='col-sm-10'>
                    <input type='text' name='lieu6' value=".stripslashes (json_encode($docs['Lieu_dorganisation'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                ...
                echo"         <div class='form-group'>
                  ...
                  <div class='col-sm-10'>
                    <input type='text' name='date6' value=".stripslashes (json_encode($docs['Date'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                ...
                echo"         <div class='form-group'>
                  ...
                  <div class='col-sm-10'>
                    <input type='text' name='lien6' value=".stripslashes (json_encode($docs['LienURL'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                ?>
                <div class="form-group">
                  ...
                  <div >
                    ...
                    <input type="button" name="anul" onclick="window.location.href='affiche5.php';" value="Annuler"   class="btn btn-theme04"/></center>
                  </div>
      ...
      $aut=explode(",",$_POST["auteur6"]);
      
      $docs=$collectionProjet->replaceOne(['_id'=> new MongoDB\BSON\ObjectId($var)],["Titre_complet"=>stripslashes($_POST['titre6']),"type"=>"Publications dans des actes de congrès scientifiques","auteurs"=>$aut,"Nom_complet"=>stripslashes($_POST['nom6']),"Lieu_dorganisation"=>stripslashes($_POST['lieu6']),"Date"=>stripslashes($_POST['date6']),"LienURL"=>stripslashes($_POST['lien6'])]);
      echo'<script>
