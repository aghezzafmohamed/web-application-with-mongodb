...
<html >
  ...
  <body>
    <section id="container" >
          ...
          <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
              ...
              <ul class="sub">
                ...
                <li class="active"><a title="Projets financés" href="affiche9.php">Projets financés</a></li>
        ...
        <section class="wrapper">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Projets financés :</h4>
              ...
              <form class='form-horizontal style-form' method='post' >
                <div class='form-group'>
                  ...
                  <div class='col-sm-10'>
                    <input type='text' name='titre10' value=".stripslashes (json_encode($docs['Titre_complet'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                ...
                echo "        <div class='form-group'>
                  ...
                  <div class='col-sm-10'>
                    <input type='text' name='responsable' value=".stripslashes (json_encode($docs['Responsable'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                
                echo "
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Domiciliation du projet</label>
                  <div class='col-sm-10'>
                    <input type='text' name='domiciliationDuProjet' value=".stripslashes(json_encode($docs['Domiciliation_du_projet'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                
                echo "
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Organisme qui finance</label>
                  <div class='col-sm-10'>
                    <input type='text' name='organismeQuiFinance' value=".stripslashes (json_encode($docs['Organisme_qui_finance'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                ...
                echo "
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Dotation</label>
                  <div class='col-sm-10'>
                    <input type='text' name='dotation' value=".stripslashes (json_encode($docs['Dotation'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                ?>
                <div class="form-group">
                  <div >
                    ...
                    <input type="button" onclick="window.location.href='affiche9.php';" name="anul" value="Annuler"  class="btn btn-theme04"/></center>
                  </div>
      ...
      $docs=$collectionProjet->replaceOne(['_id'=> new MongoDB\BSON\ObjectId($var)],["Titre_complet"=>stripslashes($_POST['titre10']),"type"=>"Projets financés","Responsable"=>stripslashes($_POST['responsable']),"Domiciliation_du_projet"=>stripslashes($_POST['domiciliationDuProjet']),"Organisme_qui_finance"=>stripslashes($_POST['organismeQuiFinance']),"Duree"=>stripslashes($_POST['duree']),"Dotation"=>stripslashes($_POST['dotation'])]);
      echo'<script>
