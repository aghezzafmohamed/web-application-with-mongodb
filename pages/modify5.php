          ...
          <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
              ...
              <ul class="sub">
                ...
                <li class="active"><a title="Chapitres d’ouvrage indexés dans des bases de données internationales" href="affiche4.php">Chapitres d’ouvrage indexés dans des bases de données internationales</a></li>
        ...
        <section class="wrapper">
          ...
          echo "  <div class='col-lg-12'>
            <div class='form-panel'>
              <h4 class='mb'><i class='fa fa-angle-right'></i> Chapitre d’ouvrage indexé dans des bases de données internationales :</h4>
              
              <form class='form-horizontal style-form' method='post'>
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Titre complet du chapitre</label>
                  <div class='col-sm-10'>
                    <input type='text' name='titre5' value=".stripslashes(json_encode($docs['Titre_complet'],JSON_UNESCAPED_UNICODE))."  class='form-control'>
                  </div>
                </div>
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Titre de l’ouvrage</label>
                  <div class='col-sm-10'>
                    <input type='text' name='titre55' value=".stripslashes(json_encode($docs['Titre_de_louvrage'],JSON_UNESCAPED_UNICODE))."  class='form-control'>
                  </div>
                </div>
                <div class='form-group'>
                ...
                <div class='form-group'>
                  ...
                  <div class='col-sm-10'>
                    <input type='text' name='maison5' value=".stripslashes(json_encode($docs['Maison_Edition'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div>
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Année</label>
                  <div class='col-sm-10'>
                    <input type='text' name='annee5' value=".stripslashes(json_encode($docs['Annee'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div>
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Lien URL</label>
                  <div class='col-sm-10'>
                    <input type='text' name='lien5' value=".stripslashes(json_encode($docs['LienURL'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                ...
                <div class="form-group">
                  ...
                  <div >
                    ...
                    <input type="button" onclick="window.location.href='affiche4.php'"  name="anul" value="Annuler"   class="btn btn-theme04"/></center>
                  </div>
          ...
          if( !empty($_POST["titre5"]) && !empty($_POST["titre55"]) && !empty($_POST["auteurs"]) && !empty($_POST["maison5"]) && !empty($_POST["annee5"])){
          $vaz="";
          $vaz=explode(",",$_POST['auteurs']);
          
          $docs=$collectionProjet->replaceOne(['_id'=> new MongoDB\BSON\ObjectId($var)],["Titre_complet"=>stripslashes($_POST['titre5']),"type"=>"Chapitres d’ouvrage indexés dans des bases de données internationales","Titre_de_louvrage"=>stripslashes($_POST['titre55']),"auteurs"=>$vaz,"Maison_Edition"=>stripslashes($_POST['maison5']),"Annee"=>stripslashes($_POST['annee5']),"LienURL"=>stripslashes($_POST['lien5'])]);
