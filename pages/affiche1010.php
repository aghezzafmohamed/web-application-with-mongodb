        ...
        <section class="wrapper">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <h4 class="mb"><i class="fa fa-angle-right"></i> Conventions signées :</h4>
              <?php
              $var="";
              echo " <table id='todo' class='table table-hover custom-check'>";
                ...
                echo "<form name='form' action='affiche101010.php' method='post'>";
                  ...
                  if($val=="Titre de la convention"){
                  $val="Titre_complet";
                  }
                  else if($val=="Type de la convention"){
                  $val="Type_de_la convention";}
                  
                  else if($val=="Institutions impliquées"){
                  $val="Institutions_impliquées";
                  }
                  else if($val=="Coordonnateur"){
                  $val="Coordonnateur";
                  }
                  else if($val=="Durée"){
                  $val="Duree";
                  }
                  else if($val=="Financement"){
                  $val="Financement";
                  }
                ...
                <table><tr><td>
                  <b>Sort &nbsp</b> <select name='choix'  id='choix' onclick='enable()' class='btn btn-default dropdown-toggle'>
                    <option></option>
                    <option>Titre_complet</option>
                    <option>Type_de_la convention</option>
                    <option>Institutions_impliquées</option>
              ...
              ";
            echo "</table> ";
            echo " <input type='hidden' name='type' value='Conventions signées'> ";
            echo " <center>
