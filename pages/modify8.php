...
<html >
  ...
  <body>
    <section id="container" >
          ...
          <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
              ...
              <ul class="sub">
                ...
                <li class="active"><a title="Brevets d’invention déposés" href="affiche7.php">Brevets d’invention déposés</a></li>
        ...
        <section class="wrapper">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Brevet d’invention déposé :</h4>
              ...
              echo"       <form class='form-horizontal style-form' method='post'  >
                <div class='form-group'>
                  ...
                  <div class='col-sm-10'>
                    <input type='text' name='titre8' value=".stripslashes (json_encode($docs['Titre_complet'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                ...
                echo"         <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'> Références</label>
                  <div class='col-sm-10'>
                    <input type='text' name='references' value=".stripslashes (json_encode($docs['References'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                
                echo"         <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Année et pays de dépôt</label>
                  <div class='col-sm-10'>
                    <input type='text' name='anneeEtPaysDeDepot' value=".stripslashes (json_encode($docs['Annee_et_pays_de_depot'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                ?>
                <div class="form-group">
                  <div >
                    ...
                    <input type="button" name="anul" value="Annuler" onclick="window.location.href='affiche7.php';"  class="btn btn-theme04"/></center>
                  </div>
      ...
      $docs=$collectionProjet->replaceOne(['_id'=> new MongoDB\BSON\ObjectId($var)],["Titre_complet"=>stripslashes($_POST['titre8']),"type"=>"Brevets d’invention déposés","auteurs"=>$aut,"References"=>stripslashes($_POST['references']),"Annee_et_pays_de_depot"=>stripslashes($_POST['anneeEtPaysDeDepot'])]);
      echo'<script>
