          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              echo " <table id='todo' class='table table-hover custom-check'>";
                ...
                echo "<form action='affiche999.php' method='post'>";
                  ...
                  if($val=="Titre du projet"){
                  $val="Titre_complet";
                  }
                  else if($val=="Responsable"){
                  $val="Responsable";}
                  
                  else if($val=="Domiciliation du projet"){
                  $val="Domiciliation_du_projet";
                  }
                  else if($val=="Organisme qui finance"){
                  $val="Organisme_qui_finance";
                  }
                  else if($val=="Durée"){
                  $val="Duree";
                  }
                  else if($val=="Dotation"){
                  $val="Dotation";
                  }
                ...
                <table><tr><td>
                  <b>Sort &nbsp</b> <select  name='choix' onclick='enable()' class='btn btn-default dropdown-toggle'>
                    ...
                    <option>Domiciliation_du_projet</option>
                    <option>Organisme_qui_finance</option>
                    <option>Duree</option>
                    <option>Dotation</option>
                  </select>&nbsp &nbsp
              ...
              ";
            echo "</table> ";
            echo " <input type='hidden' name='type' value='Projets financés'> ";
            echo " <center>
