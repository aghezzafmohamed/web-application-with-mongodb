    ...
    <section id="container" >
      ...
      <section id="main-content">
        <section class="wrapper">
          <h3><i class="fa fa-angle-right"></i> Les publications parues dans des revues internationales à comité de lecture</h3>
          <hr/>
          ...
          $docs=$collectionProjet->find(['$text'=>['$search'=>$_POST['auteurs']],'type'=>"Les publications parues dans des revues internationales à comité de lecture"],['limit'=>$limit,'sort' => [$choix =>$sort]]);
          ...
          $docs=$collectionProjet->find(['$text'=>['$search'=>$_POST['auteurs']],'type'=>"Les publications parues dans des revues internationales à comité de lecture"],['limit'=>$limit]);
          foreach($docs as $valk){
          $i=$i+1;
          }
          echo "<h5><p align='left' color='blue'><font color='orange'><b>&nbsp&nbsp &nbsp &nbsp ".$i."</b>&nbsp Element(s)</font></p></h5>" ;
