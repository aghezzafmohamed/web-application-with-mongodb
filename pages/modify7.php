...
<html >
  ...
  <body>
    <section id="container" >
          ...
          <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
              ...
              <ul class="sub">
                ...
                <li  class="active"><a title="Communications orales et posters dans des congrès scientifiques" href="affiche6.php">Communications orales et posters dans des congrès scientifiques</a></li>
        ...
        <section class="wrapper">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Communication orale et poster dans des congrès scientifiques :</h4>
              ...
              foreach($docs['auteurs'] as $cle => $val){
              if ($cle<(count($docs['auteurs'])-1)) {
              $auteur .= $val.",";
              } else {
              $auteur .= $val;
              }
              ...
              echo"         <form class='form-horizontal style-form' method='post'  >
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Titre</label>
                  <div class='col-sm-10'>
                    <input type='text' name='titre7' value=".stripslashes (json_encode($docs['Titre_complet'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                ...
                echo"         <div class='form-group'>
                  ...
                  <div class='col-sm-10'>
                    <input type='text' name='auteurs' value=".stripslashes (json_encode($auteur,JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                
                echo"         <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'> Nom complet de la rencontre scientifique</label>
                  <div class='col-sm-10'>
                    <input type='text' name='nomCompletDeLaRencontreScientifique' value=".stripslashes (json_encode($docs['Nom_complet'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                
                echo"         <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Type de la communication</label>
                  <div class='col-sm-10'>
                    <input type='text' name='typeDeLaCommunication' value=".stripslashes (json_encode($docs['Type_de_la_communication'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                
                echo"             <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Lieu d’organisation et date</label>
                  <div class='col-sm-10'>
                    <input type='text' name='lieuDorganisationEtDate' value=".stripslashes (json_encode($docs['Lieu_dorganisation_et_date'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                
                echo"              <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Lien URL</label>
                  <div class='col-sm-10'>
                    <input type='text' name='LienURL' value=".stripslashes (json_encode($docs['LienURL'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                ?>
                <div class="form-group">
                  <div >
                    ...
                    <input type="button" name="anul"  onclick="window.location.href='affiche6.php';"  value="Annuler"  class="btn btn-theme04"/></center>
                  </div>
      ...
      $aut=explode(",",$_POST["auteurs"]);
      
      $docs=$collectionProjet->replaceOne(['_id'=> new MongoDB\BSON\ObjectId($var)],["Titre_complet"=>stripslashes($_POST['titre7']),"type"=>"Communications orales et posters dans des congrès scientifiques","auteurs"=>$aut,"Nom_complet"=>stripslashes($_POST['nomCompletDeLaRencontreScientifique']),"Type_de_la_communication"=>stripslashes($_POST['typeDeLaCommunication']),"Lieu_dorganisation_et_date"=>stripslashes($_POST['lieuDorganisationEtDate']),"LienURL"=>stripslashes($_POST['LienURL'])]);
      echo'<script>
