        ...
        <section class="wrapper">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Les publications parues dans des revues internationales indexées :</h4>
              ...
              echo " <table id='todo' class='table table-hover custom-check'>";
                ...
                echo "<form name='form' action='affiche001.php' method='post'>";
              ...
              ";
            echo "</table> ";
            echo " <input type='hidden' name='type' value='Les publications parues dans des revues internationales indexées'> ";
            echo " <center>
