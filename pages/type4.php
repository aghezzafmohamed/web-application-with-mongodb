    ...
    <section id="container" >
          ...
          <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
              ...
              <ul class="sub">
                ...
                <li class="active"><a title="Ouvrages de recherche avec ISBN" href="type4.php">Ouvrages de recherche avec ISBN</a></li>
      ...
      <section id="main-content">
        <section class="wrapper">
          <h3><i class="fa fa-angle-right"></i> Ajouter</h3>
          <hr/>
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Ouvrage de recherche avec ISBN :</h4>
              
              <form class="form-horizontal style-form" method="post" action="type04.php">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Titre de l’ouvrage<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="titre4" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Auteurs (auteur1<b>,</b>auteur2)<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="auteur4" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Maison d’édition<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="maison4" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Lieu d’édition<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="lieu4" class="form-control">
                  </div>
                </div>
                
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Année de publication<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="annee4" class="form-control">
                    
                  </div>
                  
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;ISBN/ISSN<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="isbn4" class="form-control">
                    
                  </div>
                  
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Dépôt légal<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="depot4" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <div >
                    ...
                    <input type="reset" name="anul" value="Annuler"   class="btn btn-theme04"/></center>
                  </div>
