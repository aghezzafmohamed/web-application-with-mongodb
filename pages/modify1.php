    ...
    <section id="container" >
      ...
      <section id="main-content">
        <section class="wrapper">
          ...
          echo "  <div class='col-lg-12'>
            <div class='form-panel'>
              ...
              <form class='form-horizontal style-form' method='post'>
                ...
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>IF (SNIP)</label>
                  <div class='col-sm-10'>
                    <input type='text' value=".stripslashes(json_encode($docs['If'],JSON_UNESCAPED_UNICODE))." name='if' class='form-control'>
                  </div>
                </div>
                <div class='form-group'>
                ...
                <div class="form-group">
                  ...
                  <div >
                    ...
                    <input type="button" onclick="window.location.href='affiche0.php'"  name="anul" value="Annuler"   class="btn btn-theme04"/></center>
                  </div>
          ...
          if( !empty($_POST["titre"]) && !empty($_POST["auteurss"]) && !empty($_POST["nom"]) && !empty($_POST["volume"]) && !empty($_POST["if"])  && !empty($_POST["lien"])){
          $vaz="";
          $vaz=explode(",",$_POST['auteurss']);
          
          $docs=$collectionProjet->replaceOne(['_id'=> new MongoDB\BSON\ObjectId($var)],["Titre_complet"=>stripslashes($_POST['titre']),"type"=>"Les publications parues dans des revues internationales indexées","auteurs"=>$vaz,"Nom_complet"=>stripslashes($_POST['nom']),"Volume_issue_pages_et_annee"=>stripslashes($_POST['volume']),"If"=>stripslashes($_POST['if']),"LienURL"=>stripslashes($_POST['lien'])]);
