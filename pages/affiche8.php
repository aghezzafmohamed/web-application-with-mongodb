        ...
        <section class="wrapper">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <form method="post" action="affiche88.php">
                <table id="todo" class="table table-hover custom-check">
                  <tbody>
                  <tr></tr>
                  <tr>
                    <td> <span  class="check">
                      Titre de la thèse </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Titre de la thèse">
                    </span></td></tr>
                    <tr><td> <span class="check">
                    Auteur </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Auteur" checked>
                  </span></td></tr>
                  <tr><td><span class="check">
                  ...
                  <tr> <td> <span class="check">
                    Date de soutenance </td><td> <input type="checkbox" class="checked" name="chtype1[]" value="Date de soutenance">
                  </span></td></tr>
                </tbody>
              </table>
              <center>
