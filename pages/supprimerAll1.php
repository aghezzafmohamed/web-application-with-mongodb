					...
					<ul class="sidebar-menu" id="nav-accordion">
						...
						<li class="sub-menu">
							...
							<ul class="sub">
								...
								<li  class="active"><a href="supprimerAll1.php" title="Supprimer élement">Supprimer élement</a></li>
							</ul>
						</li>
						<li class="sub-menu">
							<a href="javascript:;" >
				...
				<section class="wrapper">
					...
					<div class="col-lg-12">
						<div class="form-panel">
							<form method="post" action="supprimerAll2.php">
								<table id="todo" class="table table-hover custom-check">
									<tbody>
									<tr></tr>
									<tr>
										<td> <span  class="check">
											Titre</td><td><input type="checkbox"  class="checked" name="chtype1[]" value="Titre complet">
										</span></td></tr>
										<tr><td> <span class="check">
											Auteurs </td><td><input type="checkbox" class="checked" name="chtype1[]" value="auteurs">
										</span></td></tr>
										<tr><td> <span class="check">
											Type </td><td><input type="checkbox" class="checked" name="chtype1[]" value="type">
										</span></td></tr>
										<tr><td> <span class="check">
											Nom complet</td><td><input type="checkbox" class="checked" name="chtype1[]" value="Nom complet">
										</span></td></tr>
										<tr><td> <span class="check">
											Volume, issue, pages et année </td><td><input type="checkbox" class="checked" name="chtype1[]" value="volume">
										</span></td></tr>
										<tr><td> <span class="check">
											IF (SNIP) </td><td><input type="checkbox" class="checked" name="chtype1[]" value="If">
										</span></td></tr>
										<tr><td> <span class="check">
											Lien URL </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Lien URL">
										</span></td></tr>
										<tr><td> <span class="check">
											Maison d’édition </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Maison d’édition">
										</span></td></tr>
										<tr><td> <span class="check">
											Année</td><td><input type="checkbox" class="checked" name="chtype1[]" value="Annee">
										</span></td></tr>
										<tr><td> <span class="check">
											ISBN/ISSN</td><td><input type="checkbox" class="checked" name="chtype1[]" value="ISBN/ISSN">
										</span></td></tr>
										<tr><td> <span class="check">
											Dépôt légal </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Dépôt légal">
										</span></td></tr>
										<tr><td> <span class="check">
											Date </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Date">
										</span></td></tr>
										<tr><td> <span class="check">
											Type de la communication</td><td><input type="checkbox" class="checked" name="chtype1[]" value="Type de la communication">
										</span></td></tr>
										<tr><td> <span class="check">
											Références </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Références">
										</span></td></tr>
										<tr><td> <span class="check">
											Directeur de Thèse </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Directeur de Thèse">
										</span></td></tr>
										<tr><td> <span class="check">
											Membres du jury </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Membres du jury">
										</span></td></tr>
										<tr><td> <span class="check">
											Domiciliation du projet </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Domiciliation du projet">
										</span></td></tr>
										<tr><td> <span class="check">
											Dotation </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Dotation">
										</span></td></tr>
										<tr><td> <span class="check">
											Coordonnateur </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Coordonnateur">
										</span></td></tr>
										<tr><td> <span class="check">
											Financement </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Financement">
										</span></td></tr>
									</tbody>
								</table>
								<center>
