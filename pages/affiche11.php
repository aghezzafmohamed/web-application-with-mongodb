        ...
        <section class="wrapper">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Les publications parues dans des revues internationales à comité de lecture :</h4>
              ...
              echo " <table id='todo' class='table table-hover custom-check'>";
                ...
                echo "<form action='affiche111.php' method='post'>";
                  ...
                  if($val=="Titre complet de la publication"){
                  $val="Titre_complet";
                  }
                  else if($val=="auteurs"){
                  $val="auteurs";}
                  else if($val=="Nom complet du périodique scientifique"){
                  $val="Nom_complet";
                  }
                  else if($val=="Volume issue pages et année"){
                  $val="Volume_issue_pages_et_annee";
                  }
                ...
                <table><tr><td>
                  <b>Sort &nbsp</b> <select  name='choix' onclick='enable()' class='btn btn-default dropdown-toggle'>
                    ...
                    <option>Volume_issue_pages_et_annee</option>
              ...
              ";
            echo "</table> ";
            echo " <input type='hidden' name='type' value='Les publications parues dans des revues internationales à comité de lecture'> ";
            echo " <center>
