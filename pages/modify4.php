    ...
    <section id="container" >
          ...
          <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
              ...
              <ul class="sub">
                ...
                <li class="active"><a title="Ouvrages de recherche avec ISBN" href="affiche3.php">Ouvrages de recherche avec ISBN</a></li>
      ...
      <section id="main-content">
        <section class="wrapper">
          <h3><i class="fa fa-angle-right"></i> Modifier</h3>
          <hr/>
          <?php
          $var=$_GET['id'];
          require "outils/vendor/autoload.php";
          ...
          $auteur="";
          $docs=$collectionProjet->findOne(['_id'=>new MongoDB\BSON\ObjectId($var)]);
          foreach($docs['auteurs'] as $ae =>$vz){
          if($ae<(count($docs['auteurs'])-1)){
          $auteur.=$vz.",";
          ...
          echo "  <div class='col-lg-12'>
            <div class='form-panel'>
              <h4 class='mb'><i class='fa fa-angle-right'></i> Ouvrage de recherche avec ISBN :</h4>
              
              <form class='form-horizontal style-form' method='post'>
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Titre de l’ouvrage</label>
                  <div class='col-sm-10'>
                    <input type='text' name='titre4' value=".stripslashes(json_encode($docs['Titre_complet'],JSON_UNESCAPED_UNICODE))."  class='form-control'>
                  </div>
                </div>
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Auteurs</label>
                  <div class='col-sm-10'>
                    <input type='text' name='auteurss' value=".stripslashes(json_encode($auteur,JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div>
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Maison d’édition</label>
                  <div class='col-sm-10'>
                    <input type='text' name='maison4' value=".stripslashes(json_encode($docs['Maison_Edition'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div>
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Lieu d’édition</label>
                  <div class='col-sm-10'>
                    <input type='text' name='lieu4' value=".stripslashes(json_encode($docs['Lieu_Edition'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div>
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Année de publication</label>
                  <div class='col-sm-10'>
                    <input type='text' name='annee4' value=".stripslashes(json_encode($docs['Annee'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                    
                  </div>
                  
                </div>
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>ISBN/ISSN</label>
                  <div class='col-sm-10'>
                    <input type='text' name='isbn4' value=".stripslashes(json_encode($docs['ISBN/ISSN'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                    
                  </div>
                  
                </div>
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Dépôt légal</label>
                  <div class='col-sm-10'>
                    <input type='text' name='depot4' value=".stripslashes(json_encode($docs['Depot_legal'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                ...
                <div class="form-group">
                  ...
                  <div >
                    <center>
                    <input type="submit" onclick="return confirm('Voulez-vous vraiment modifier ces champs?')" name="envoie" value="Modifier" class="btn btn-theme02"/>
                    <input type="button" onclick="window.location.href='affiche3.php'"  name="anul" value="Annuler"   class="btn btn-theme04"/></center>
                  </div>
          ...
          if( !empty($_POST["titre4"]) && !empty($_POST["auteurss"]) && !empty($_POST["maison4"]) && !empty($_POST["lieu4"]) && !empty($_POST["annee4"]) && !empty($_POST["isbn4"]) && !empty($_POST["depot4"])){
          $vaz="";
          $vaz=explode(",",$_POST['auteurss']);
          
          $docs=$collectionProjet->replaceOne(['_id'=> new MongoDB\BSON\ObjectId($var)],["Titre_complet"=>stripslashes($_POST["titre4"]),"type"=>"Ouvrages de recherche avec ISBN","auteurs"=>$vaz,"Maison_Edition"=>stripslashes($_POST["maison4"]),"Lieu_Edition"=>stripslashes($_POST["lieu4"]),"Annee"=>stripslashes($_POST["annee4"]),"ISBN/ISSN"=>stripslashes($_POST["isbn4"]),"Depot_legal"=>stripslashes($_POST["depot4"])]);
          
          echo'<script>
          alert("La modification est bien effectuée.");
