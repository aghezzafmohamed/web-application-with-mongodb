          ...
          <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
              ...
              <ul class="sub">
                ...
                <li class="active"><a  title="Brevets d’invention déposés" href="type8.php">Brevets d’invention déposés</a></li>
        ...
        <section class="wrapper">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="post" action="type08.php">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Titre<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="titre8" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Références<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="references" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Année et pays de dépôt<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="anneeEtPaysDeDepot" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <div >
