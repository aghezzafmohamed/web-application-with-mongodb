        ...
        <section class="wrapper">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Publications dans des actes de congrès scientifiques  :</h4>
              ...
              echo " <table id='todo' class='table table-hover custom-check'>";
                ...
                echo "<form action='affiche555.php' method='post'>";
                  ...
                  $val="Nom_complet";}
                  else if($val=="Lieu d’organisation"){
                  $val="Lieu_dorganisation";
                  }
                  else if($val=="Date"){
                  $val="Date";
                  }
                ...
                <table><tr><td>
                  <b>Sort &nbsp</b> <select  name='choix' onclick='enable()' class='btn btn-default dropdown-toggle'>
                    ...
                    <option>Lieu_dorganisation</option>
                    <option>Date</option>
              ...
              ";
            echo "</table> ";
            echo " <input type='hidden' name='type' value='Publications dans des actes de congrès scientifiques'> ";
            echo " <center>
