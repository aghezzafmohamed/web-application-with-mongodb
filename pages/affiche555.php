  ...
  <body>
    <section id="container" >
      ...
      <header class="header black-bg">
        ...
        <div class="nav pull-right top-menu" style="margin-top: 15px; margin-right: 15px;">
          <div class="btn-group"  >
            <i style="color: #ffff; font-size:2.3rem;" type="button" class="fa fa-chevron-down fa-2x" data-toggle="dropdown">
            <span ></span>
            </i>
            <ul class="dropdown-menu pull-right">
              <div class="notify-arrow notify-arrow-green"  style="margin-left: 130px;"></div>
      ...
      <section id="main-content">
        <section class="wrapper">
          <h3><i class="fa fa-desktop"></i> Publications dans des actes de congrès scientifiques</h3>
          <hr/>
          ...
          $i=0;
          if(!empty($_POST["auteurs"]) && empty($_POST["Titre_complet"]) && empty($_POST["Nom_complet"]) && empty($_POST["Lieu_dorganisation"]) && empty($_POST["Date"])  && empty($_POST["LienURL"])){
          $re=$collectionProjet->dropIndexes();
          $ee=$collectionProjet->createIndex(["auteurs"=>"text"]);
          if(isset($choix) && isset($sort)){
          $docs=$collectionProjet->find(['$text'=>['$search'=>$_POST['auteurs']],'type'=>"Publications dans des actes de congrès scientifiques"],['limit'=>$limit,'sort' => [$choix =>$sort]]);
          ...
          echo "<div class='col-lg-12' >
            <div class='form-panel'>
              ...
              echo '<table height="60" width="100%">';
          ...
          $docs=$collectionProjet->find(['$text'=>['$search'=>$_POST['auteurs']],'type'=>"Publications dans des actes de congrès scientifiques"],['limit'=>$limit]);
          foreach($docs as $valk){
          $i=$i+1;
          }
          echo "<h5><p align='left' color='blue'><font color='orange'><b>&nbsp&nbsp &nbsp &nbsp ".$i."</b>&nbsp Element(s)</font></p></h5>" ;
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center text-white">
              <p><center><font color=white>Créer par: AGHEZZAF Mohamed & MEZOIR Hassan</font></center> </p>
