        ...
        <section class="wrapper">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Chapitres d’ouvrage indexés dans des bases de données internationales :</h4>
              ...
              echo " <table id='todo' class='table table-hover custom-check'>";
                ...
                echo "<form action='affiche444.php' method='post'>";
                  ...
                  if($val=="Titre complet du chapitre"){
                  $val="Titre_complet";
                  }
                  if($val=="Titre de l’ouvrage"){
                  $val="Titre_de_louvrage";
                  }
                  else if($val=="auteurs"){
                  $val="auteurs";}
                  else if($val=="Maison d’édition"){
                  $val="Maison_Edition";
                  }
                  else if($val=="Année"){
                  $val="Annee";
                ...
                <table><tr><td>
                  <b>Sort &nbsp</b> <select  name='choix' onclick='enable()' class='btn btn-default dropdown-toggle'>
                    ...
                    <option>Titre_de_louvrage</option>
                    <option>Maison_Edition</option>
                    <option>Annee</option>
              ...
              ";
            echo "</table> ";
            echo ' <input type="hidden" name="type" value="Chapitres d’ouvrage indexés dans des bases de données internationales"> ';
            echo " <center>
