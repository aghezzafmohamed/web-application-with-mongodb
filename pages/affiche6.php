        ...
        <section class="wrapper">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <form method="post" action="affiche66.php">
                <table id="todo" class="table table-hover custom-check">
                  <tbody>
                  <tr></tr>
                  <tr>
                    <td> <span  class="check">
                      Titre complet de la communication </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Titre complet de la communication">
                    </span></td></tr>
                    <tr><td> <span class="check">
                    Auteurs </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Auteurs" checked>
                  </span></td></tr>
                  <tr><td><span class="check">
                    Nom complet de la rencontre scientifique </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Nom complet de la rencontre scientifique">
                  </span></td></tr>
                  <tr> <td> <span class="check">
                    Type de la communication </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Type de la communication">
                  </span></td></tr>
                  <tr> <td> <span class="check">
                    Lieu d’organisation et date </td><td> <input type="checkbox" class="checked" name="chtype1[]" value="Lieu d’organisation et date">
                  </span></td></tr>
                  <tr> <td> <span class="check">
