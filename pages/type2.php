          ...
          <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
              ...
              <ul class="sub">
                ...
                <li class="active"><a title="Les publications parues dans des revues internationales à comité de lecture" href="type2.php">Publications parues dans des revues internationales à comité de lecture</a></li>
        ...
        <section class="wrapper">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Publication parue dans des revues internationales à comité de lecture :</h4>
              
              <form class="form-horizontal style-form" method="post" action="type02.php">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Titre<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="titre2" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Auteurs (auteur1<b>,</b>auteur2)<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="auteur2" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="lien2" class="form-control">
