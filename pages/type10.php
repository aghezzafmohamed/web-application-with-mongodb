          ...
          <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
              ...
              <ul class="sub">
                ...
                <li class="active"><a title="Projets financés" href="type10.php">Projets financés</a></li>
        ...
        <section class="wrapper">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Projet financé :</h4>
              <form class="form-horizontal style-form" method="post" action="type010.php">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Titre<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="titre10" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Responsable<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="responsable" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Domiciliation du projet<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="domiciliationDuProjet" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Organisme qui finance<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="organismeQuiFinance" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Durée<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="duree" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Dotation<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="dotation" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <div >
