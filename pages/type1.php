				...
				<div id="sidebar"  class="nav-collapse " >
					<ul class="sidebar-menu" id="nav-accordion">
						...
						<li class="sub-menu">
							...
							<ul class="sub">
								<li class="active"><a title="Les publications parues dans des revues internationales indexées" href="type1.php">Publications parues dans des revues internationales indexées</a></li>
				...
				<section class="wrapper">
					...
					<div class="col-lg-12">
						<div class="form-panel">
							...
							<form class="form-horizontal style-form" method="post" action="type01.php" >
								...
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;IF (SNIP)<font color=orange size=4><b>*</b></font></label>
									<div class="col-sm-8">
