...
<html >
  ...
  <body>
    <section id="container" >
        ...
        <section class="wrapper">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Convention signée : </h4>
              <?php
              $var=$_GET['id'];
              require "outils/vendor/autoload.php";
              $client=new MongoDB\Client;
              ...
              echo "  <form class='form-horizontal style-form' method='post' >
                <div class='form-group'>
                  ...
                  <div class='col-sm-10'>
                    <input type='text' name='titre11' value=".stripslashes (json_encode($docs['Titre_complet'],JSON_UNESCAPED_UNICODE))."  class='form-control'>
                  </div>
                </div>";
                
                echo " <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Type de la convention</label>
                  <div class='col-sm-10'>
                    <input type='text' name='type11' value=".stripslashes (json_encode($docs['Type_de_la convention'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                
                echo "   <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Institutions impliquées</label>
                  <div class='col-sm-10'>
                    <input type='text' name='institutionsImpliquees' value=".stripslashes (json_encode($docs['Institutions_impliquées'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                
                echo "    <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Coordonnateur</label>
                  <div class='col-sm-10'>
                    <input type='text' name='coordonnateur' value=".stripslashes (json_encode($docs['Coordonnateur'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                ...
                echo "    <div class='form-group'>
                  ...
                  <div class='col-sm-10'>
                    <input type='text' name='duree' value=".stripslashes (json_encode($docs['Duree'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                
                echo"    <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Financement</label>
                  <div class='col-sm-10'>
                    <input type='text' name='financement' value=".stripslashes (json_encode($docs['Financement'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div> ";
                ...
                <div class="form-group">
                  ...
                  <div >
                    ...
                    <input type="button" onclick="window.location.href='affiche10.php';"  name="anul" value="Annuler"   class="btn btn-theme04"/></center>
                  </div>
                </div>
              </form>
            </div>
      ...
      $docs=$collectionProjet->replaceOne(['_id'=> new MongoDB\BSON\ObjectId($var)],["Titre_complet"=>stripslashes($_POST['titre11']),"type"=>"Conventions signées","Type_de_la convention"=>$_POST['type11'],"Institutions_impliquées"=>stripslashes($_POST['institutionsImpliquees']),"Coordonnateur"=>stripslashes($_POST['coordonnateur']),"Duree"=>stripslashes($_POST['duree']),"Financement"=>stripslashes ($_POST['financement'])]);
