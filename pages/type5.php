          ...
          <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
              ...
              <ul class="sub">
                ...
                <li class="active"><a title="Chapitres d’ouvrage indexés dans des bases de données internationales" href="type5.php">Chapitres d’ouvrage indexés dans des bases de données internationales</a></li>
        ...
        <section class="wrapper">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="post" action="type05.php">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Titre complet du chapitre<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="titre5" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Titre de l’ouvrage<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="titre55" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Auteurs (auteur1<b>,</b>auteur2)<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="auteur5" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Maison d’édition<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="maison5" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">&nbsp;&nbsp;&nbsp;&nbsp;Année<font color=orange size=4><b>*</b></font></label>
                  <div class="col-sm-8">
                    <input type="text" name="annee5" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="lien5" class="form-control">
                  </div>
                </div>
                <div class="form-group">
