    ...
    <section id="container" >
        ...
        <div id="sidebar"  class="nav-collapse " >
          <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
              ...
              <ul class="sub">
                <li class="active"><a   href="import.php" title="Import">Import</a> </li>
      ...
      <section id="main-content">
        ...
        <section class="wrapper">
          <h3><i class="fa fa-download"></i> Importer une collection :</h3>
          <hr/>
          ...
          <div class="col-lg-12" >
            <div class="form-panel" >
              ...
              <form method="post" enctype="multipart/form-data">
                <table>
                  <tr>
                    <td width=42%><input type="radio" name="mod" value="insert" checked> Insérer</td>
                    <td width=42%><input type="radio" name="mod" value="merge"> Mélanger</td>
                    <td width=42%><input type="radio" name="mod" value="upsert"> Remplacer </td>
                  </tr>
                </table>
                </br>
                <center><input title="Importer" accept=".json"  class="btn btn-unique btn-sm float-left" type="file" id="real-file" name="fichier"/><br/></center>
                
                <center><input onclick="return confirm('Voulez-vous vraiment importer cette collection ?')" class="btn btn-success btn-round btn-info" type="submit"  value="Importer" name="envoi"/></center>
              </form>
              <?php
              $collection=$_GET["valuecollection"];
              try{
              ...
              if($collection=="collectionProjet"){
              if($_POST['mod']=='insert'){
                        $var=system(" mongoimport --db dbProjet --collection collectionProjet --file ".$_FILES['fichier']['tmp_name']);
                      }
                      else{
              $var=system(" mongoimport --db dbProjet --collection collectionProjet --mode ".$_POST['mod']." --file ".$_FILES['fichier']['tmp_name']);
                      }
              echo '<script language="JavaScript">
              window.location.replace("index.php");
              </script>';
              }
              if($collection=="authentification"){
              echo $collection;
              system(" mongoimport --db dbProjet --collection authentification --mode ".$_POST['mod']." --file ".$_FILES['fichier']['tmp_name']);
              echo '<script language="JavaScript">
              window.location.replace("index.php");
              </script>';
              }
              ...
              echo '<script language="JavaScript">
              alert("veuillez choisir dabord le fichier à importer");
