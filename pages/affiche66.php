        ...
        <section class="wrapper">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Communications orales et posters dans des congrès scientifiques :</h4>
              ...
              echo " <table id='todo' class='table table-hover custom-check'>";
                ...
                if(!isset($_POST['chtype1[]'])){
                
                echo "<form action='affiche666.php' method='post'>";
                  
                  foreach($_POST['chtype1'] as $val){
                  
                  echo "<tr><th> ";
                  echo $val; echo "</th><td> ";
                  
                  if($val=="Titre complet de la communication"){
                  $val="Titre_complet";
                  }
                  else if($val=="Auteurs"){
                  $val="auteurs";}
                  
                  else if($val=="Nom complet de la rencontre scientifique"){
                  $val="Nom_complet";
                  }
                  else if($val=="Type de la communication"){
                  $val="Type_de_la_communication";
                  }
                  else if($val=="Lieu d’organisation et date"){
                  $val="Lieu_dorganisation_et_date";
                  }
                  else if($val=="Lien URL"){
                  $val="LienURL";
                  }
                echo " <input type='text'  class='form-control' name='$val'> </td></tr>";
                }
                echo" <tr><td><b><font color='orange'>Option de l'affichage</font></b></td><td>
                
                <table><tr><td>
                  <b>Sort &nbsp</b> <select  name='choix' onclick='enable()' class='btn btn-default dropdown-toggle'>
                    <option></option>
                    <option>Titre_complet</option>
                    <option>auteurs</option>
                    <option>Nom_complet</option>
                    <option>Type_de_la_communication</option>
                    <option>Lieu_dorganisation_et_date</option>
                    <option>LienURL</option>
                  </select>
                  <b>Order &nbsp</b> <select name='sort' id='sort' disabled  class='btn btn-default dropdown-toggle'>
                    <option></option>
                    <option>a-z</option>
                    <option>z-a</option>
                    </select></td><td width=6%></td><td>  <b>Limit </b>&nbsp &nbsp  </td><td>
                  <input type='number'  name='lim' class='form-control'></td></tr></table>
                </td>
              ...
              ";
            echo "</table> ";
            echo " <input type='hidden' name='type' value='Communications orales et posters dans des congrès scientifiques'> ";
            echo " <center>
            <input type='submit' name='envoi' value='Afficher'  class='btn btn-theme03'/></center></form>";
            }
            else{
            
            echo '<script language="JavaScript">
            alert("Vous avez oublié de remplir un champ. Merci de recommencer");
            window.location.replace("affich0.php");
            </script>';
            }
            ?>
          </div>
