		...
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					<h3><i class="fa fa-user fa-faw"></i> Profile :</h3>
					<hr/><h4>
					<div class="col-lg-12" >
						<div class="form-panel" >
							
							<form class="form-horizontal style-form" method="post" class="centre" >
								<center><p class="centered"><img src="<?php echo $upload_dir.$admin['pathImage'] ;?>" class="img-circle" width="110"></p><center><br><br>
								<table cellpadding=0 cellspacing=0 >
									<tr ><th width='62%' ><font size=4>Prenom :</th><td><center><?php echo $admin["prenom"];?></center> </font></td></tr>
									<tr ><td colspan=2> <hr id='hr1'></td></tr>
									<tr><th><font size=4 >Nom :</th><td><center><?php echo $admin["nom"];?></center> </font></td></tr>
									<tr ><td colspan=2> <hr id='hr1'></td></tr>
									<tr><th><font size=4>Email :</th><td><center><?php echo $admin["email"];?></center> </font></td></tr>
								</table>
								<br><br>
								<div class="form-group" style="font-color: wieth; height: 40px; width:100%; ">
								</div>
							<div  align='left'> </form>
							<p style= "font: 12pt/18pt serif">
								<a href="parametre.php" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="blue" size="3">Modifier les paramétres</font></a><br>
								<a href="passe.php" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="blue" size="3">Modifier le mot de passe</font></a><br>
								<a href="autreAdmin.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="blue" size="3">Ajouter nouveau Compte</font></a><br>
								<p>
								</div>
