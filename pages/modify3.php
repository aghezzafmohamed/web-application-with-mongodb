          ...
          <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
              ...
              <ul class="sub">
                ...
                <li class="active"><a title="Les publications parues dans des revues nationales à comité de lecture" href="affiche2.php">Publications parues dans des revues nationales à comité de lecture</a></li>
        ...
        <section class="wrapper">
          ...
          echo "  <div class='col-lg-12'>
            <div class='form-panel'>
              <h4 class='mb'><i class='fa fa-angle-right'></i> Publications parues dans des revues internationales indexées :</h4>
              ...
              <form class='form-horizontal style-form' method='post'>
                ...
                <div class="form-group">
                  ...
                  <div >
                    ...
                    <input type="button" onclick="window.location.href='affiche2.php'"  name="anul" value="Annuler"   class="btn btn-theme04"/></center>
                  </div>
          ...
          $docs=$collectionProjet->replaceOne(['_id'=> new MongoDB\BSON\ObjectId($var)],["Titre_complet"=>stripslashes($_POST['titre']),"type"=>"Les publications parues dans des revues nationales à comité de lecture","auteurs"=>$vaz,"Nom_complet"=>stripslashes($_POST['nom']),"Volume_issue_pages_et_annee"=>stripslashes($_POST['volume']),"LienURL"=>stripslashes($_POST['lien'])]);
