				...
				<section class="wrapper">
					...
					<div class="col-lg-12">
						<div class="form-panel">
							<?php
								echo '	<center><p class="centered"><img src='.$upload_dir.$admin['pathImage'].' class="img-circle" width="110"></p>
							<form name="fa" method="post" class="form-horizontal style-form" enctype="multipart/form-data" >
									...
									<table>
											...
											<td><br><input style="width:380px;" type="text" name="prenom" value='.stripslashes (json_encode($admin["prenom"],JSON_UNESCAPED_UNICODE)).' class="form-control"></td></tr>
											<tr><td><br><font size="3"> Nom :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font></td>
											<td><br><input style="width:380px;" type="text" name="nom" value='.stripslashes (json_encode($admin["nom"],JSON_UNESCAPED_UNICODE)).' class="form-control"></td></tr>
							...
							if($admin['pseudo']== md5($_POST['pass'])){
							...
							if(in_array($imgExt, $allowExt)){
								if($imgSize < 5000000){
									...
									unlink($upload_dir.$admin['pathImage']);
									move_uploaded_file($imgTmp ,$upload_dir.$userPic);
								}
								else{
									echo"<br><br><center><p style='width:380px; height:55px;' class='alert alert-danger' align='center'> <font size='3%'><strong>Erreur! &nbsp;</strong> Image trop grande(Max=5Mo). </font></p></center>";
							}
							}else{
