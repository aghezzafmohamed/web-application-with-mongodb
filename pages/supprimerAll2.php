						...
						<div class="form-panel">
							...
							echo " <table id='todo' class='table table-hover custom-check'>";
											...
											if(!isset($_POST['chtype1[]'])){
												...
												echo "<form action='supprimerAll3.php' method='post'>";
							...
							echo "</table> ";
								echo ' <center>';
							?>
							<input type="submit" name="envoi" onclick="return confirm('Voulez-vous vraiment Supprimer ?')" value="Supprimer" class="btn btn-round btn-danger"/>
							<?php
						echo "</center></form>";
