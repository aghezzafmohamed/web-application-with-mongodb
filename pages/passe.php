				...
				<section class="wrapper">
					...
					<div class="col-lg-12">
						<div class="form-panel">
							<center><p class="centered"><img src="<?php echo $upload_dir.$admin['pathImage'] ?>" class="img-circle" width="110"></p>
							<form name="fa" method="post" class="form-horizontal style-form" >
								<br><br>
								<table>
									
									<tr><td> <font size="3">Mot de passe actuel :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font></td>
									...
									<tr><td><br><font size="3" ><p align='right'>Confirmer le mot de passe:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </p></font></td>
							...
							if( md5($_POST['pass1'])==$admin['pseudo'] && $_POST['pass2']==$_POST['pass3'] && $_POST['pass2']>=5){
