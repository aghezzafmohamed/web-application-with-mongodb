					...
					<ul class="sidebar-menu" id="nav-accordion">
						...
						<li class="sub-menu">
							...
							<ul class="sub">
								...
								<li><a title="Ouvrages de recherche avec ISBN" href="pages/affiche3.php">Ouvrages de recherche avec ISBN</a></li>
								...
								<li><a title="Brevets d’invention déposés" href="pages/affiche7.php">Brevets d’invention déposés</a></li>
						...
						<li class="sub-menu">
							...
							<ul class="sub">
								...
								<li><a title="Ouvrages de recherche avec ISBN" href="pages/type4.php">Ouvrages de recherche avec ISBN</a></li>
								...
								<li><a title="Brevets d’invention déposés" href="pages/type8.php">Brevets d’invention déposés</a></li>
						...
						<div class="form-panel">
							<div class="table-responsive">
								<table class="table table-striped">
									...
									<?php
									echo "  <tbody>";
											// $d1=$collectionProjet->findOne();
											$dbProjet=$client->dbProjet;
											$collectionProjet=$dbProjet->collectionProjet;
											$d22=$authentification->find([],['sort'=>['date'=>-1]]);
											foreach($d22 as $d2 ){
											$a=$d2['prenom'].' '. $d2['nom'];
											$d=$collectionProjet->count();
											
											$d1=$collectionProjet->count(['auteurs'=>$a]);
											$nbr=($d1/$d)*100;
											...
											<tr>
													...
													<td class="py-1">';
														if($d2['type']=='admin')
															echo	'<img src="uploads/'.$d2['pathImage'].'" width="33" alt="image" />';
													else
															echo	'<img src="../pages2/uploads/'.$d2['pathImage'].'" width="33" alt="image" />';
													echo	'</td>
													<td>
															'.$a.'
													</td>
													...
													<td>
															<div class="progress">
																	<div class="progress-bar bg-success" role="progressbar" style="width: '.$nbr.'%"></div>
															</div>
													</td>
													<td>
															'. $d2['email'].'
