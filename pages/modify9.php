...
<html >
  ...
  <body>
    <section id="container" >
          ...
          <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
              ...
              <ul class="sub">
                ...
                <li class="active"><a title="Thèses de doctorat soutenues et encadrées par un membre de la structure"  href="affiche8.php">Thèses de doctorat soutenues et encadrées par un membre de la structure</a></li>
        ...
        <section class="wrapper">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Thèse de doctorat soutenue et encadrée par un membre de la structure :</h4>
              <?php
              $var=$_GET['id'];
              $auteur="";
              require "outils/vendor/autoload.php";
              ...
              echo"      <form class='form-horizontal style-form' method='post'  >
                <div class='form-group'>
                  ...
                  <div class='col-sm-10'>
                    <input type='text' name='titre9' value=".stripslashes (json_encode($docs['Titre_complet'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div>";
                ...
                echo"       <div class='form-group'>
                  ...
                  <div class='col-sm-10'>
                    <input type='text' name='auteur' value=".stripslashes (json_encode($auteur,JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div>";
                
                echo"       <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'> Directeur de Thèse</label>
                  <div class='col-sm-10'>
                    <input type='text' name='directeurDeThese' value=".stripslashes (json_encode($docs['Directeur_de_These'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div>";
                
                echo"       <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Membres du jury</label>
                  <div class='col-sm-10'>
                    <input type='text' name='membresDuJury' value=".stripslashes (json_encode($docs['Membres_du_jury'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div>";
                
                echo"       <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Date de soutenance</label>
                  <div class='col-sm-10'>
                    <input type='text' name='dateDeSoutenance' value=".stripslashes (json_encode($docs['Date_de_soutenance'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div>";
                ?>
                <div class="form-group">
                  <div >
                    ...
                    <input type="button" name="anul" onclick="window.location.href='affiche8.php';" value="Annuler"   class="btn btn-theme04"/></center>
                  </div>
      ...
      if( !empty($_POST["titre9"]) && !empty($_POST["auteur"]) && !empty($_POST["directeurDeThese"]) && !empty($_POST["membresDuJury"]) ){
      
      $aut=explode(",",$_POST["auteur"]);
      
      $docs=$collectionProjet->replaceOne(['_id'=> new MongoDB\BSON\ObjectId($var)],["Titre_complet"=>stripslashes($_POST['titre9']),"type"=>"Thèses de doctorat soutenues et encadrées par un membre de la structure","auteurs"=>$aut,"Directeur_de_These"=>stripslashes($_POST['directeurDeThese']),"Membres_du_jury"=>stripslashes($_POST['membresDuJury']),"Date_de_soutenance"=>stripslashes($_POST['dateDeSoutenance'])]);
      echo'<script>
