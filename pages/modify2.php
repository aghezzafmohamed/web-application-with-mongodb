          ...
          <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
              ...
              <ul class="sub">
                ...
                <li class="active"><a title="Les publications parues dans des revues internationales à comité de lecture" href="affiche1.php">Publications parues dans des revues internationales à comité de lecture</a></li>
        ...
        <section class="wrapper">
          ...
          echo "  <div class='col-lg-12'>
            <div class='form-panel'>
              <h4 class='mb'><i class='fa fa-angle-right'></i> Publication parue dans des revues internationales indexées :</h4>
              
              <form class='form-horizontal style-form' method='post'>
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Titre</label>
                  <div class='col-sm-10'>
                    <input type='text' name='titre' value=".stripslashes(json_encode($docs['Titre_complet'],JSON_UNESCAPED_UNICODE))."  class='form-control'>
                  </div>
                </div>
                <div class='form-group'>
                ...
                <div class='form-group'>
                  ...
                  <div class='col-sm-10'>
                    <input type='text' name='nom' value=".stripslashes(json_encode($docs['Nom_complet'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div>
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Volume, issue, pages et année</label>
                  <div class='col-sm-10'>
                    <input type='text' name='volume' value=".stripslashes(json_encode($docs['Volume_issue_pages_et_annee'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                  </div>
                </div>
                <div class='form-group'>
                  <label class='col-sm-2 col-sm-2 control-label'>Lien URL</label>
                  <div class='col-sm-10'>
                    <input type='text' name='lien' value=".stripslashes(json_encode($docs['LienURL'],JSON_UNESCAPED_UNICODE))." class='form-control'>
                ...
                <div class="form-group">
                  ...
                  <div >
                    ...
                    <input type="button" onclick="window.location.href='affiche1.php'"  name="anul" value="Annuler"   class="btn btn-theme04"/></center>
                  </div>
                </div>
              </form>
            </div>
          ...
          if( !empty($_POST["titre"]) && !empty($_POST["auteurss"]) && !empty($_POST["nom"]) && !empty($_POST["volume"])  && !empty($_POST["lien"])){
          $vaz="";
          $vaz=explode(",",$_POST['auteurss']);
          $docs=$collectionProjet->replaceOne(['_id'=> new MongoDB\BSON\ObjectId($var)],["Titre_complet"=>stripslashes($_POST['titre']),"type"=>"Les publications parues dans des revues internationales à comité de lecture","auteurs"=>$vaz,"Nom_complet"=>stripslashes($_POST['nom']),"Volume_issue_pages_et_annee"=>stripslashes($_POST['volume']),"LienURL"=>stripslashes($_POST['lien'])]);
