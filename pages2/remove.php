		...
		<section id="container" >
			...
			<header class="header black-bg">
				<div class="sidebar-toggle-box">
					<div class="fa fa-bars tooltips" style="color: #ffff;" data-placement="right" data-original-title="Basculer la navigation"></div>
				</div>
				...
				<div class="sidebar-toggle-box" style="margin-top:13px;">
					...
					<div class="nav pull-right top-menu" style="margin-top: 16px; margin-right: 15px;">
						<div class="btn-group"  >
				...
				<section id="main-content">
					<section class="wrapper">
						<h3><i class="fa fa-user-times"></i> Paramètre : </h3>
						<hr/>
						<div class="col-lg-12">
							...
							<div class="form-panel">
								<center><p class="centered"><img src="<?php echo $upload_dir.$utilisateur['pathImage'] ?>" class="img-circle" width="90"></p>
								<form name="fa" method="post" class="form-horizontal style-form" >
									...
									<input type="submit" name="envoie" value="Supprimer" class="btn btn-theme04" onclick="return confirm('Voulez-vous vraiment Supprimer ?')"/>
									<input type="reset" name="anul" value="Annuler" onclick="window.location.href='profile.php';"  class="btn btn-theme03"/>
								</form></center>
								<?php
								
								
								if(isset($_POST['envoie'])){
								if(!empty($_POST['passe']) && md5($_POST['passe'])==$utilisateur['pseudo']){
								
								$auth=$authentification->deleteOne(["email"=>$utilisateur['email']]);
								session_destroy();
								echo'<script>
								window.location.replace("../login.php");
								</script>';
