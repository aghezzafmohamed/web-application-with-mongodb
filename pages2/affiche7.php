					...
					<section class="wrapper">
						...
						<div class="col-lg-12">
							<div class="form-panel">
								...
								<form method="post" action="affiche77.php">
									<table id="todo" class="table table-hover custom-check">
										<tbody>
										<tr></tr>
										<tr>
											<td> <span  class="check">
												Titre du brevet </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Titre du brevet">
											</span></td></tr>
										...
										<tr> <td> <span class="check">
											Année et pays de dépôt </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Année et pays de dépôt">
										</span></td></tr>
