          ...
          <section class="wrapper">
            ...
            echo  "<div class='col-lg-12' >
              <div class='form-panel'>
                ...
                echo "<tr><td><font size='3.5px'><b>Lien URL </b></font></td><td style='word-spacing: 2px;letter-spacing: 1px;'><b>&nbsp&nbsp<a target='_blank' href=".$valk['LienURL'].">Accéder au lien</a></b></td></tr>";
              echo '</table><br>';
            echo "   </div></div><br> <br>";
            }
            }else{
