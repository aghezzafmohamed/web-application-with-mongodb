      ...
      <header class="header black-bg">
        ...
        <section id="main-content">
          <section class="wrapper">
            <h3><i class="fa fa-desktop"></i> Communications orales et posters dans des congrès scientifiques</h3>
            <hr/>
            ...
            $docs=$collectionProjet->find(['$text'=>['$search'=>$_POST['auteurs']],'type'=>"Communications orales et posters dans des congrès scientifiques"],['limit'=>$limit,'sort' => [$choix =>$sort]]);
            ...
            $docs=$collectionProjet->find(['$text'=>['$search'=>$_POST['auteurs']],'type'=>"Communications orales et posters dans des congrès scientifiques"],['limit'=>$limit]);
            foreach($docs as $valk){
            $i=$i+1;
            }
            echo "<h5><p align='left' color='blue'><font color='orange'><b>&nbsp&nbsp &nbsp &nbsp ".$i."</b>&nbsp Element(s)</font></p></h5>" ;
