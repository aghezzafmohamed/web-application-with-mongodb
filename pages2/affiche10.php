					...
					<section class="wrapper">
						...
						<div class="col-lg-12">
							<div class="form-panel">
								...
								<form method="post" action="affiche1010.php">
									<table id="todo" class="table table-hover custom-check">
										<tbody>
										<tr></tr>
										<tr>
											<td> <span  class="check">
											Titre de la convention </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Titre de la convention" checked>
										</span></td></tr>
										<tr><td> <span class="check">
											Type de la convention </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Type de la convention">
										</span></td></tr>
										<tr><td><span class="check">
											Institutions impliquées </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Institutions impliquées">
										</span></td></tr>
										<tr> <td> <span class="check">
