      ...
      <header class="header black-bg">
        ...
        <section id="main-content">
          <section class="wrapper">
            <h3><i class="fa fa-desktop"></i> Thèses de doctorat soutenues et encadrées par un membre de la structure</h3>
            <hr/>
            ...
            if(!empty($_POST["auteurs"]) && empty($_POST["Titre_complet"]) && empty($_POST["Directeur_de_These"]) && empty($_POST["Membres_du_jury"]) && empty($_POST["Date_de_soutenance"])){
            $re=$collectionProjet->dropIndexes();
            $ee=$collectionProjet->createIndex(["auteurs"=>"text"]);
            if(isset($choix) && isset($sort)){
            $docs=$collectionProjet->find(['$text'=>['$search'=>$_POST['auteurs']],'type'=>"Thèses de doctorat soutenues et encadrées par un membre de la structure"],['limit'=>$limit,'sort' => [$choix =>$sort]]);
            ...
            echo  "<div class='col-lg-12' >
              <div class='form-panel'>
                ...
                echo "<tr><td><font size='3.5px'><b>Date de soutenance </b></font></td><td style='word-spacing: 0.6px;'><b>&nbsp&nbsp".$valk['Date_de_soutenance']."</b></td></tr>";
              echo '</table><br>';
            echo "   </div></div><br> <br>";
            }
            }else{
            
            $docs=$collectionProjet->find(['$text'=>['$search'=>$_POST['auteurs']],'type'=>"Thèses de doctorat soutenues et encadrées par un membre de la structure"],['limit'=>$limit]);
            foreach($docs as $valk){
            $i=$i+1;
            }
            echo "<h5><p align='left' color='blue'><font color='orange'><b>&nbsp&nbsp &nbsp &nbsp ".$i."</b>&nbsp Element(s)</font></p></h5>" ;
