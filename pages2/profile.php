						...
						<div class="col-lg-12" >
							<div class="form-panel" >
								...
								<form class="form-horizontal style-form" method="post" class="centre" >
									<center><p class="centered"><img src="<?php echo $upload_dir.$utilisateur['pathImage'] ?>" class="img-circle" width="110"></p><center><br><br>
									<table cellpadding=0 cellspacing=0 >
										<tr ><th width='62%' ><font size=4>Nom :</th><td><center><?php echo $utilisateur["nom"];?> </center></font></td></tr>
										<tr ><td colspan=2> <hr id='hr1'></td></tr>
										<tr><th><font size=4 >Prenom :</th><td><center><?php echo $utilisateur["prenom"];?> </center></font></td></tr>
										<tr ><td colspan=2> <hr id='hr1'></td></tr>
										<tr><th><font size=4>Email :</th><td><center><?php echo $utilisateur["email"];?></center> </font></td></tr>
									</table>
									<br><br>
								...
								<p style= "font: 12pt/18pt serif">
									...
									<a href="remove.php" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="blue" size="3">Supprimer votre compte</font></a><br>
									<p>
									</div>
