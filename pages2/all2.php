            ...
            echo "<div class='col-lg-12' >
              <div class='form-panel'>
                ...
                echo '<table  height="180" width="100%">';
                  ...
                  echo "<tr><td width='33%'><font size='3.5px'><b>&nbsp&nbsp Titre de l’ouvrage  </b></font></td><td style='word-spacing: 2px;letter-spacing: 1px;'><b>&nbsp&nbsp".$valk['Titre_complet']."</b></td></tr>";
                  if(empty($valk['auteurs']))
                  echo "-----</br>";
                  else{
