					...
					<section class="wrapper">
						...
						<div class="col-lg-12">
							<div class="form-panel">
								...
								<form method="post" action="affiche99.php">
									<table id="todo" class="table table-hover custom-check">
										<tbody>
										<tr></tr>
										<tr>
											<td> <span  class="check">
											Titre du projet </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Titre du projet" checked>
										</span></td></tr>
										<tr><td> <span class="check">
											Responsable </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Responsable">
										</span></td></tr>
										<tr><td><span class="check">
											Domiciliation du projet </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Domiciliation du projet">
										</span></td></tr>
										<tr> <td> <span class="check">
											Organisme qui finance </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Organisme qui finance">
										</span></td></tr>
										<tr> <td> <span class="check">
											Durée </td><td> <input type="checkbox" class="checked" name="chtype1[]" value="Durée">
										</span></td></tr>
										<tr> <td> <span class="check">
