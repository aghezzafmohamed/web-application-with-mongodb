          ...
          <section class="wrapper">
            ...
            <div class="col-lg-12">
              <div class="form-panel">
                <h4 class="mb"><i class="fa fa-angle-right"></i> Thèses de doctorat soutenues et encadrées par un membre de la structure :</h4>
                ...
                echo " <table id='todo' class='table table-hover custom-check'>";
                  ...
                  echo "<form action='affiche888.php' method='post'>";
                    ...
                    if($val=="Titre de la thèse"){
                    $val="Titre_complet";
                    }
                    else if($val=="Auteur"){
                    $val="auteurs";}
                    
                    else if($val=="Directeur de Thèse"){
                    $val="Directeur_de_These";
                    }
                    else if($val=="Membres du jury"){
                    $val="Membres_du_jury";
                    }
                    else if($val=="Date de soutenance"){
                    $val="Date_de_soutenance";
                    }
                  ...
                  <table><tr><td>
                    <b>Sort &nbsp</b> <select  name='choix' onclick='enable()' class='btn btn-default dropdown-toggle'>
                      ...
                      <option>Directeur_de_These</option>
                      <option>Membres_du_jury</option>
                      <option>Date_de_soutenance</option>
                    </select>&nbsp &nbsp
                ...
                ";
              echo "</table> ";
              echo " <input type='hidden' name='type' value='Thèses de doctorat soutenues et encadrées par un membre de la structure'> ";
              echo " <center>
