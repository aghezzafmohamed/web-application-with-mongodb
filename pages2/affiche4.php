					...
					<section class="wrapper">
						...
						<div class="col-lg-12">
							<div class="form-panel">
								...
								<form method="post" action="affiche44.php">
									<table id="todo" class="table table-hover custom-check">
										<tbody>
										<tr></tr>
										<tr>
											<td> <span  class="check">
												Titre complet du chapitre </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Titre complet du chapitre">
											</span></td></tr>
											<tr><td><span class="check">
												Titre de l’ouvrage </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Titre de l’ouvrage">
											</span></td></tr>
											<tr><td> <span class="check">
										...
										<tr> <td> <span class="check">
											Année </td><td> <input type="checkbox" class="checked" name="chtype1[]" value="Année">
										</span></td></tr>
										<tr> <td> <span class="check">
