					...
					<section class="wrapper">
						...
						<div class="col-lg-12">
							<div class="form-panel">
								<center><p class="centered"><img src="<?php echo $upload_dir.$utilisateur['pathImage'] ?>" class="img-circle" width="110"></p>
								<form name="fa" method="post" class="form-horizontal style-form" >
									<br><br>
									<table>
										
										<tr><td> <font size="3">Ancien mot de passe :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font></td>
										<td><input type="password" name="pass1" class="form-control" style="width:380px;"></td></tr>
										
										<tr><td><br><font size="3" >Nouveau Mot de passe :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font></td>
										<td><br><input type="password" name="pass2"  class="form-control" style="width:380px;"></td></tr>
										<tr><td><br><font size="3" >Confirmer Mot de passe:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font></td>
										<td><br><input type="password" name="pass3"  class="form-control" style="width:380px;"></td></tr>
								...
								if( md5($_POST['pass1'])==$utilisateur['pseudo'] && $_POST['pass2']==$_POST['pass3']){
									if( strlen($_POST['pass2'])>5){
									$docs=$authentification->updateOne(['codeActivate'=>$_SESSION['auto']],['$set'=>['pseudo'=>md5($_POST['pass2'])]]);
								echo'<script>
															window.location.replace("profile.php");
								</script>';
								}else{
								echo"<br><br><center><p style='width:400px; height:55px;' class='alert alert-danger' align='center'> <font size='3%'><strong>Erreur! &nbsp;</strong> Le mot de passe est insuffisant. </font></p></center>";
