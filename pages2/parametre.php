			...
			<header class="header black-bg">
				...
				<section id="main-content">
					<section class="wrapper">
						<h3><i class="fa fa-cogs fa-1x"></i> Parmmétre : </h3>
						<hr>
						<div class="col-lg-12">
							<div class="form-panel">
								<?php
									echo '	<center><p class="centered"><img src='.$upload_dir.$utilisateur['pathImage'].' class="img-circle" width="110"></p>
								<form name="fa" method="post" class="form-horizontal style-form" enctype="multipart/form-data" >
										<input accept="image/png, image/jpeg" type="file" name="image" title="Modifier votre photo" >
										
										<table>
												<tr><td><br><font size="3">Prenom :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td>
												<td><br><input style="width:380px;" type="text" name="prenom" value='.stripslashes (json_encode($utilisateur["prenom"],JSON_UNESCAPED_UNICODE)).' class="form-control"></td></tr>
												<tr><td><br><font size="3"> Nom :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font></td>
												<td><br><input style="width:380px;" type="text" name="nom" value='.stripslashes (json_encode($utilisateur["nom"],JSON_UNESCAPED_UNICODE)).' class="form-control"></td></tr>
												<tr><td><br><font size="3">Mot de passe :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </font></td>
												<td><br><input style="width:380px;" type="password" name="pass"  class="form-control"></td></tr>
												<tr><td ><br><br></td><td></td></tr>
										</table>
									<input type="submit" name="envoie" value="Modifier" class="btn btn-theme03"/>';?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type='reset' name='anul' value='Annuler' onclick="window.location.href='profile.php';" class='btn btn-theme04'/></center>
									<?php
								echo '	</form>
								...
								if($utilisateur['pseudo']== md5($_POST['pass'])){
								...
								if(in_array($imgExt, $allowExt)){
									if($imgSize < 5000000){
										...
										unlink($upload_dir.$utilisateur['pathImage']);
										move_uploaded_file($imgTmp ,$upload_dir.$userPic);
									}else{
										echo"<br><br><center><p style='width:380px; height:55px;' class='alert alert-danger' align='center'> <font size='3%'><strong>Erreur! &nbsp;</strong> Image trop grande. </font></p></center>";
								}
								}else{
									//echo"<br><br><center><p style='width:380px; height:55px;' class='alert alert-danger' align='center'> <font size='3%'><strong>Erreur! &nbsp;</strong> Veuillez sélectionner une image valide. </font></p></center>";
								}
								
								if( $imgExt==""){
									$auth=$authentification->updateOne(["codeActivate"=>$_SESSION['auto']],['$set'=>['prenom'=>$_POST['prenom'],'nom'=>$_POST['nom']]]);
								echo'<script>window.location.replace("profile.php");</script>';
								}else{
								$auth=$authentification->updateOne(["codeActivate"=>$_SESSION['auto']],['$set'=>["pathImage"=>$userPic,'prenom'=>$_POST['prenom'],'nom'=>$_POST['nom']]]);
								echo'<script>window.location.replace("profile.php");</script>';
								}
								}
								}
								else{
								echo"<br><br><center><p style='width:380px; height:55px;' class='alert alert-danger' align='center'> <font size='3%'><strong>Erreur! &nbsp;</strong> Mot de passe incorrect. </font></p></center>";
								}
								}
								?>
							</div></div>
