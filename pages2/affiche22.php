            ...
            <div class="col-lg-12">
              <div class="form-panel">
                ...
                echo " <table id='todo' class='table table-hover custom-check'>";
                  ...
                  echo "<form action='affiche222.php' method='post'>";
                ...
                ";
              echo "</table> ";
              echo " <input type='hidden' name='type' value='Les publications parues dans des revues nationales à comité de lecture'> ";
              echo " <center>
