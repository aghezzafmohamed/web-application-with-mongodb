					...
					<section class="wrapper">
						...
						<div class="col-lg-12">
							<div class="form-panel">
								<h4 class="mb"><i class="fa fa-angle-right"></i> Les publications parues dans des revues nationales à comité de lecture :</h4>
								
								<form method="post" action="affiche22.php">
									<table id="todo" class="table table-hover custom-check">
										<tbody>
										<tr></tr>
										<tr>
											<td> <span  class="check">
												Titre complet de la publication </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Titre complet de la publication">
											</span></td></tr>
											<tr><td> <span class="check">
											Auteurs </td><td><input type="checkbox" class="checked" name="chtype1[]" value="auteurs" checked>
										</span></td></tr>
										<tr><td><span class="check">
											Nom complet du périodique scientifique </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Nom complet du périodique scientifique">
										</span></td></tr>
										<tr> <td> <span class="check">
											Volume, issue, pages et année </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Volume issue pages et année">
										</span></td></tr>
										<tr> <td> <span class="check">
								...
								<center>
								<input type="submit" name="envoi" value="envoyer" class="btn btn-theme03"/></center>
							</form>
						</div>
					</div>
