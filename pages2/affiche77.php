          ...
          <section class="wrapper">
            ...
            <div class="col-lg-12">
              <div class="form-panel">
                <h4 class="mb"><i class="fa fa-angle-right"></i> Brevets d’invention déposés :</h4>
                ...
                echo " <table id='todo' class='table table-hover custom-check'>";
                  ...
                  echo "<form action='affiche777.php' method='post'>";
                    ...
                    if($val=="Titre du brevet"){
                    $val="Titre_complet";
                    }
                    else if($val=="Auteurs"){
                    $val="auteurs";}
                    
                    else if($val=="Références"){
                    $val="References";
                    }
                    else if($val=="Année et pays de dépôt"){
                    $val="Annee_et_pays_de_depot";
                    }
                  ...
                  <table><tr><td>
                    <b>Sort &nbsp</b> <select  name='choix' onclick='enable()' class='btn btn-default dropdown-toggle'>
                      ...
                      <option>Annee_et_pays_de_depot</option>
                    </select>&nbsp &nbsp
                ...
                ";
              echo "</table> ";
              echo " <input type='hidden' name='type' value='Brevets d’invention déposés'> ";
              echo " <center>
