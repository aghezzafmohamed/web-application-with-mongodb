      ...
      <header class="header black-bg">
        ...
        <section id="main-content">
          <section class="wrapper">
            <h3><i class="fa fa-desktop"></i> Les publications parues dans des revues nationales à comité de lecture</h3>
            <hr/>
            ...
            $i=0;
            if(!empty($_POST["auteurs"]) && empty($_POST["Titre_complet"]) && empty($_POST["Nom_complet"])  && empty($_POST["Volume_issue_pages_et_annee"]) && empty($_POST["LienURL"]) ){
            $re=$collectionProjet->dropIndexes();
            $ee=$collectionProjet->createIndex(["auteurs"=>"text"]);
            if(isset($choix) && isset($sort)){
            $docs=$collectionProjet->find(['$text'=>['$search'=>$_POST['auteurs']],'type'=>"Les publications parues dans des revues nationales à comité de lecture"],['limit'=>$limit,'sort' => [$choix =>$sort]]);
            ...
            $docs=$collectionProjet->find(['$text'=>['$search'=>$_POST['auteurs']],'type'=>"Les publications parues dans des revues nationales à comité de lecture"],['limit'=>$limit]);
            foreach($docs as $valk){
            $i=$i+1;
            }
            echo "<h5><p align='left' color='blue'><font color='orange'><b>&nbsp&nbsp &nbsp &nbsp ".$i."</b>&nbsp Element(s)</font></p></h5>" ;
            ...
            echo "<div class='col-lg-12' >
              <div class='form-panel'>
                ...
                echo '<table height="180" width="100%" >';
                  ...
                  echo "<tr><td width='33%'><font size='3.5px'><b>Titre complet de la publication  </b></font></td><td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td align='left' style='word-spacing: 2px;letter-spacing: 1px;'><b>".$valk['Titre_complet']."</b></td></tr>";
                  if(empty($valk['auteurs']))
                  echo "-----<br>";
                  else{
                  echo "<tr><td><font size='3.5px'><b>Auteurs  </b></font></td><td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td style='word-spacing: 2px;letter-spacing: 1px;'><b>";
