					...
					<section class="wrapper">
						...
						<div class="col-lg-12">
							<div class="form-panel">
								...
								<form method="post" action="affiche33.php">
									<table id="todo" class="table table-hover custom-check">
										...
										<tr> <td> <span class="check">
											Lieu d’édition </td><td><input type="checkbox" class="checked" name="chtype1[]" value="Lieu d’édition">
										</span></td></tr>
										<tr> <td> <span class="check">
											Année de publication </td><td> <input type="checkbox" class="checked" name="chtype1[]" value="Année de publication">
										</span></td></tr>
										<tr> <td> <span class="check">
